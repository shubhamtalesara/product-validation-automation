...
function fakeTrendtrackClient(): TrendtrackClient {
  ...
  const details: Record<string, unknown> = {
    "ad-2": {
      ...
      status: "active",
      daysRunning: 40,
      media: { type: "video", mediaUrl: "https://cdn.example.com/ad2.mp4" },
      content: { body: "Copy", title: "Headline", callToAction: "SHOP_NOW", landingPageUrl: "https://x.com" },
    ...
    "ad-3": {
      ...
      status: "active",
      daysRunning: 5,
      media: { type: "image", mediaUrl: "https://cdn.example.com/ad3.jpg" },
      content: { body: "Copy 3", title: "Headline 3", callToAction: "LEARN_MORE", landingPageUrl: "https://y.com" },
